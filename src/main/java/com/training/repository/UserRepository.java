...
//  find all user
	@Results({ @Result(property = "groupRole", column = "group_role"), })
	...
	public List<User> findUserByOption(@Param("page") Integer page, @Param("size") Integer size,  @Param("user") User user);
